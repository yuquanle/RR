...
file1 = open("cail_small/data_train.json", 'r', encoding='utf-8')
file2 = open("cail_small/data_test.json", 'r', encoding='utf-8')
file3 = open("cail_small/data_valid.json", 'r', encoding='utf-8')
...
outputfile1 = open("cail_small/train_cs.json", "w", encoding='utf-8')
outputfile2 = open("cail_small/test_cs.json", "w", encoding='utf-8')
outputfile3 = open("cail_small/valid_cs.json", "w", encoding='utf-8')
