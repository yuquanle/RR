...
class DataFilter(object):
    ...
    def fact_process(self):
        ...
        target_files = [self.train_file, self.test_file]
        str_pass = '二审'
        longest_imprison = 0
        regex_list = [
                    ...
                    if (str_pass in fact_description["fact"] != -1 or
                        ...
                        if law_to_nums[law] in filtered_law_list and accu_to_nums[accu] in filtered_accu_list:
                            ...
                            if temp_term["death_penalty"] == True or temp_term["life_imprisonment"] == True:
                                ...
                                new_sample["term"] = 0
                            elif temp_term["imprisonment"] > 10 * 12:
                                new_sample["term"] = 1
                            elif temp_term["imprisonment"] > 7 * 12:
                                new_sample["term"] = 2
                            elif temp_term["imprisonment"] > 5 * 12:
                                new_sample["term"] = 3
                            elif temp_term["imprisonment"] > 3 * 12:
                                new_sample["term"] = 4
                            elif temp_term["imprisonment"] > 2 * 12:
                                new_sample["term"] = 5
                            elif temp_term["imprisonment"] > 1 * 12:
                                new_sample["term"] = 6
                            elif temp_term["imprisonment"] > 9:
                                new_sample["term"] = 7
                            elif temp_term["imprisonment"] > 6:
                                new_sample["term"] = 8
                            elif temp_term["imprisonment"] > 0:
                                new_sample["term"] = 9
                            else:
                                new_sample["term"] = 10
...
if __name__ == "__main__":
    data_filter = DataFilter("./law.txt", "./accu.txt", "./cail_big/big_law.txt", "./cail_big/big_accu.txt",
                             "./cail_big/big_train.json", "./cail_big/big_test.json")
